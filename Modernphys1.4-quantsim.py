# Modern Physics Coder Section.
# Credits to Andrew Yang, Eric Podol, Aaditya Singh (and Abhinav Raghavan)
# Takes user input, and then simulate a quantum situation.
...
# Part II: Allow the user to make a scenario: Finite Well, Harmonic Oscillator, or Infinite Well. 

x = sp.symbols('x')
choice = int(input("Please choose a scenario number:\nFinite Well (E < U_o) [1]\nInfinite Well [2]\nHarmonic Oscillator [3] Quantum Oscilaltor\n"))
...
# Quantum Oscillator:
    ...
    print("Welcome. You will be entering values for w (angular frequency measured in radians per second) and n (an integer)). This will return the energy state for the quantum harmonic oscillator. \nInput your value for w in the 10^7 and 10^8 range.")
